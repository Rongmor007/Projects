					...
					<tr class="level:0">
						...
						<td>
							...
							<xsl:if test="n1:ResultSet/n1:TestGroup/n1:Events/n1:Event[@ID='Error Message']/n1:Data[@name='Error Message']">
								...
								<span style="color:#FF0000;">:<xsl:value-of select="n1:ResultSet/n1:TestGroup/n1:Events/n1:Event[@ID='Error Message']/n1:Data[@name='Error Message']/c:Datum/c:Value"/>
			...
			<tr>
				...
				<td colspan="{$gSecondColumnSpan}">
					...
					<span style="color:#FF0000;">
						<xsl:value-of disable-output-escaping="yes" select="n1:Event[@ID='Error Message']/n1:Data[@name='Error Message']/c:Datum/c:Value"/> [Error Code: <xsl:value-of select="$errCode"/>]</span>
				</td>
			</tr>
		</xsl:if>
	</xsl:template>
