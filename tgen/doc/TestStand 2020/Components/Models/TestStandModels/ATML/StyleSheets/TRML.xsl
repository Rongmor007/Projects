...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="http://www.ieee.org/ATML/2007/TestResults" xmlns:c="http://www.ieee.org/ATML/2006/Common" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ts="www.ni.com/TestStand/ATMLTestResults/1.0" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:user="http://www.ni.com/TestStand/ATML/4.5" id="TS20.0.0">
    ...
    <xsl:apply-templates select="n1:TestStation/c:Definition/c:Extension/ts:TSAdditionalData/ts:TSCollection/c:Item[@name='AdditionalData']/c:Collection">
      <xsl:with-param name="DataNode" select="n1:TestStation/c:Definition/c:Extension/ts:TSAdditionalData/ts:TSCollection/c:Item[@name='AdditionalData']"/>
      <xsl:with-param name="ObjectPath" select="''"/>
    </xsl:apply-templates>
	...
	<xsl:template name="GetDatumTypeName">
		...
		<xsl:choose>
			...
			<xsl:when test="$xsiType = 'ts:TS_enum'">Enumerator</xsl:when>
		</xsl:choose>
	</xsl:template>
	<xsl:template name="AddDatumValue">
		...
		<xsl:choose>
			...
			<xsl:when test="$xsiType = 'c:double'">
				<xsl:choose>
