...
%% set names_of_headers = ['Ток в цепях аналоговых температурных датчиков', 'Цепь №', 'Измерено (мА)', 'Допустимое значение (мА)', 'Показания аналаговых температурных датчиков С']
