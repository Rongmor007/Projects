						...
						<xsl:when test="tr:ResultSet/tr:Outcome/@qualifier">
							...
							<span style="font-weight:normal">
								<xsl:if test="tr:ResultSet/tr:Outcome/@qualifier='Error'">
									<xsl:if test="tr:ResultSet/tr:Events/tr:Event[@ID='Error Message']">, <xsl:variable name="isValueEscaped" select="tr:ResultSet/tr:Events/tr:Event[@ID='Error Message']/tr:Data/c:Datum/@isEscaped = 'true'"/> <xsl:value-of disable-output-escaping="yes" select="user:ReplaceWhitespaceAndNewLine(tr:ResultSet/tr:Events/tr:Event[@ID='Error Message']/tr:Data/c:Datum/c:Value, true(), $isValueEscaped)"/>
									</xsl:if>
