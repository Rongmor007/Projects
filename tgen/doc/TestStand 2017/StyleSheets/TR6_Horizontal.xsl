<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:trc="urn:IEEE-1636.1:2013:TestResultsCollection" xmlns:tr="urn:IEEE-1636.1:2013:TestResults" xmlns:c="urn:IEEE-1671:2010:Common" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ts="www.ni.com/TestStand/ATMLTestResults/3.0" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:user="http://www.ni.com/TestStand" id="TS19.0.0">
	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<xsl:value-of select="user:GetPathsOfGraphControlScripts(//trc:TestResults/tr:Extension/ts:TS_Configuration/c:Collection/c:Item[@name='StylesheetPath'])" disable-output-escaping="yes"/>
			</head>
